...
public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) {
                log.info("Verificando catálogo inicial de ingredientes y recetas...");
        ...
        private Map<String, Ingrediente> inicializarIngredientes() {
                ...
                for (Ingrediente ing : lista) {
                        Ingrediente guardado = ingredienteRepository.findByNombreIgnoreCase(ing.getNombre())
                                        .orElseGet(() -> ingredienteRepository.save(ing));
        ...
        private void inicializarRecetas(Map<String, Ingrediente> ings) {
                // Receta 1: Arroz con Huevo Frito
                if (!recetaRepository.existsByTitulo("Arroz con Huevo Frito")) {
                ...
                // Receta 2: Panqueques Caseros
                if (!recetaRepository.existsByTitulo("Panqueques Caseros")) {
                ...
                if (!recetaRepository.existsByTitulo("Pasta con Salsa de Tomate y Queso")) {
                ...
                if (!recetaRepository.existsByTitulo("Tortilla de Papas y Cebolla")) {
                ...
                // Receta 5: Lasaña de Carne Bolognesa
                if (!recetaRepository.existsByTitulo("Lasaña de Carne Bolognesa")) {
        ...
        private void receta(Map<String, Ingrediente> ings, String titulo, String descripcion, String instrucciones,
                ...
                if (recetaRepository.existsByTitulo(titulo)) {
                        return;
                }
